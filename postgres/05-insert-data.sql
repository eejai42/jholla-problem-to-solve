...
VALUES ('ev-a-1', 'ev-a-1', 'cm-a', 'assay-a-rna', 0.91, 0.2, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.91 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-a-2', 'ev-a-2', 'cm-a', 'assay-a-atac', 0.73, 0.19, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.73 (SE 0.19)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-a-3', 'ev-a-3', 'cm-a', 'assay-a-prot', 0.66, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.66 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-b-1', 'ev-b-1', 'cm-b', 'assay-b-rna', 0.84, 0.21, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.84 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-b-2', 'ev-b-2', 'cm-b', 'assay-b-atac', 0.79, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.79 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-b-3', 'ev-b-3', 'cm-b', 'assay-b-prot', 0.58, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.58 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-c-1', 'ev-c-1', 'cm-c', 'assay-c-rna', 1.02, 0.225, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 1.02 (SE 0.23)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-c-2', 'ev-c-2', 'cm-c', 'assay-c-atac', 0.61, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.61 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-c-3', 'ev-c-3', 'cm-c', 'assay-c-prot', 0.55, 0.215, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.55 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-d-1', 'ev-d-1', 'cm-d', 'assay-d-rna', 0.88, 0.205, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.88 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-d-2', 'ev-d-2', 'cm-d', 'assay-d-atac', 0.95, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.95 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-d-3', 'ev-d-3', 'cm-d', 'assay-d-prot', 0.62, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.62 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-e-1', 'ev-e-1', 'cm-e', 'assay-e-rna', 0.79, 0.21, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.79 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-h-1', 'ev-h-1', 'cm-h', 'assay-h-rna', 0.91, 0.2, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.91 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-h-2', 'ev-h-2', 'cm-h', 'assay-h-atac', 0.73, 0.19, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.73 (SE 0.19)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-h-3', 'ev-h-3', 'cm-h', 'assay-h-prot', 0.66, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.66 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-i-1', 'ev-i-1', 'cm-i', 'assay-i-rna', 0.88, 0.205, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.88 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-i-2', 'ev-i-2', 'cm-i', 'assay-i-atac', 0.95, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.95 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-i-3', 'ev-i-3', 'cm-i', 'assay-i-prot', 0.62, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.62 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-j-1', 'ev-j-1', 'cm-j', 'assay-j-rna', 0.84, 0.21, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.84 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-j-2', 'ev-j-2', 'cm-j', 'assay-j-atac', 0.79, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.79 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-j-3', 'ev-j-3', 'cm-j', 'assay-j-prot', 0.58, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.58 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-k-1', 'ev-k-1', 'cm-k', 'assay-k-rna', 1.07, 0.205, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 1.07 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-k-2', 'ev-k-2', 'cm-k', 'assay-k-atac', 0.83, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.83 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-k-3', 'ev-k-3', 'cm-k', 'assay-k-prot', 0.74, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.74 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-l-1', 'ev-l-1', 'cm-l', 'assay-l-rna', 0.96, 0.2, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.96 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-l-2', 'ev-l-2', 'cm-l', 'assay-l-atac', 0.88, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.88 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-l-3', 'ev-l-3', 'cm-l', 'assay-l-prot', 0.69, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.69 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-e-2', 'ev-e-2', 'cm-e', 'assay-e-atac', 0.71, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.71 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-e-3', 'ev-e-3', 'cm-e', 'assay-e-prot', 0.41, 0.2, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.41 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-f-1', 'ev-f-1', 'cm-f', 'assay-f-rna', 1.07, 0.205, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 1.07 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-f-2', 'ev-f-2', 'cm-f', 'assay-f-atac', 0.83, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.83 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-f-3', 'ev-f-3', 'cm-f', 'assay-f-prot', 0.74, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.74 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-g-1', 'ev-g-1', 'cm-g', 'assay-g-rna', 0.96, 0.2, FALSE, FALSE, NULL, TRUE, TRUE, 'cis-eQTL, blood RNA-seq', 'colocalization PP4>0.8; no horizontal pleiotropy on the eQTL instrument', 'cis-eQTL in blood RNA-seq with effect 0.96 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-g-2', 'ev-g-2', 'cm-g', 'assay-g-atac', 0.88, 0.21, TRUE, FALSE, NULL, TRUE, TRUE, 'caQTL, blood ATAC-seq', 'open-chromatin peak maps to the credible set; cell-state confounding adjusted', 'caQTL in blood ATAC-seq with effect 0.88 (SE 0.21)') ON CONFLICT (evidence_item_id) DO NOTHING;

INSERT INTO evidence_items (evidence_item_id, evidence_label, causal_mechanism, omics_assay, effect_size, standard_error, is_cross_modality, is_negative_control_arm, is_adjusted_for_ancestry_pcs, is_adjusted_for_batch, is_synthetic_leaf, represents_assay_modality, identification_assumption, source_quote)
VALUES ('ev-g-3', 'ev-g-3', 'cm-g', 'assay-g-prot', 0.69, 0.205, TRUE, FALSE, NULL, TRUE, TRUE, 'pQTL, blood mass-spec proteomics', 'cis-pQTL within 1Mb; aptamer/epitope-binding artifact excluded', 'pQTL in blood proteomics with effect 0.69 (SE 0.20)') ON CONFLICT (evidence_item_id) DO NOTHING;
...
INSERT INTO leopold_loops (leopold_loop_id, loop_number, title, goal, status, rule_commit_msg, state_commit_msg, sort_order, status_badge, status_line)
VALUES ('loop-1', '1', 'Intake app skeleton', 'Turn keystone-level red tests green: wire cohort + prediction-panel endpoints reading vw_*.', 'done', 'none - app-only loop, no rule change', 'state: Loop 1 - read-only intake app surfaces the keystone', 2, '[DONE]', '') ON CONFLICT (leopold_loop_id) DO NOTHING;
...
INSERT INTO leopold_loops (leopold_loop_id, loop_number, title, goal, status, rule_commit_msg, state_commit_msg, sort_order, status_badge, status_line)
VALUES ('loop-llm-intake', '12', 'LLM intake clerk + synthetic lab', 'The trust-boundary payoff: wire the LLM to read a natural-language case and write ONLY leaf observations - intake facts + synthetic-but-transparent test results - with the three-panel witness (case text / extracted facts with per-fact provenance / derived diagnosis + gate trace). The LLM never computes a higher-order inference; every value it emits is an editable knob. Demotes the model to a replaceable, fully-overridable transcriber - the structural defeat of ''a hallucination laundered through a deterministic function.''', 'planned', 'rule (if any) for provenance fields', 'state: Loop 12 - LLM intake clerk, everything-is-a-knob', 13, '[PLANNED]', '') ON CONFLICT (leopold_loop_id) DO NOTHING;

INSERT INTO leopold_loops (leopold_loop_id, loop_number, title, goal, status, rule_commit_msg, state_commit_msg, sort_order, status_badge, status_line)
VALUES ('loop-equity', '13', 'Cohort-level equity report', 'Ancestry-equity made structural and corpus-level: calibration and actionability rates by ancestry (gates 2 and 4 of the keystone) as a derived dashboard, complementing the cohort discovery board. Equity is a checkable rate, not a promise.', 'backlog', '', '', 14, '[BACKLOG]', '') ON CONFLICT (leopold_loop_id) DO NOTHING;

INSERT INTO leopold_loops (leopold_loop_id, loop_number, title, goal, status, rule_commit_msg, state_commit_msg, sort_order, status_badge, status_line)
VALUES ('loop-prune-nonloadbearing', '14', 'Prune excess engineering - keep only what is load-bearing for the v2 audit response', 'A deliberate trimming pass (NOT a delete spree). Walk the model, the app, and the docs and find anything that was UPGRADED or SUPERSEDED and now lingers as a duplicate, plus any engineering that is not actually load-bearing toward the clearest pedagogical answer to the v1 audit. Candidates to scrutinise: superseded prediction types that don''t earn their keep (e.g. a 4th parallel adverse-effect prediction once severity + treatment-response + treatment-line exist), redundant ontology slots that no longer carry a claim, and any view/endpoint with no consumer. Promotion rule inverted: if a thing is neither traceable to problem-to-solve.md nor load-bearing toward the keystone or the audit response, retire it. Goal: the clearest, most complete, DUPLICATE-FREE representation of the problem.', 'backlog', '', '', 15, '[BACKLOG]', '') ON CONFLICT (leopold_loop_id) DO NOTHING;
