...
INSERT INTO leopold_loops (leopold_loop_id, loop_number, title, goal, status, rule_commit_msg, state_commit_msg, sort_order, status_badge, status_line)
VALUES ('loop-3', '3', 'Gate explainability in the UI', 'Show why each gate passed/failed one level down; consider installing the explainer-DAG transpiler.', 'next', 'rule: install explainer-dag', 'state: Loop 3 - gate explainability', 4, '[NEXT]', '') ON CONFLICT (leopold_loop_id) DO NOTHING;
